function t41spec(moduleId, appFolder, entityType) {
  console.log('stv t41', moduleId, appFolder, entityType);

  describe("t41 - content-type with create permissions for anonymous", function () {
