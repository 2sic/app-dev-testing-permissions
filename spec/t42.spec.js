function t42spec(moduleId, appFolder, entityType) {
  console.log('stv t42', moduleId, appFolder, entityType);

  describe("t42 - content-type with create-draft permissions for anonymous", function () {
