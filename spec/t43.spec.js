function t43spec(moduleId, appFolder, entityType) {
  console.log('stv t43', moduleId, appFolder, entityType);

  describe("t43 - content-type with read permissions for anonymous", function () {
